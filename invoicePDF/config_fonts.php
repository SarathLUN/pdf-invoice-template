...
$this->fontdata = array(
    ...
    "battambang" => array(/* Khmer */
        'R' => "Battambang.ttf",
        'useOTL' => 0xFF,
    ),
    "khmerfef1" => array(/* Khmer */
        'R' => "KHMERMEF1.ttf",
        'useOTL' => 0xFF,
    ),
    "khmerfef2" => array(/* Khmer */
        'R' => "KHMERMEF2.ttf",
        'useOTL' => 0xFF,
    ),
);
...
$this->sans_fonts = array('dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
	...
	'humanist777', 'humanist777black', 'humanist777light', 'futura', 'hobo', 'segoeprint','khmeros','battambang','khmerfef1','khmerfef2'
);
...
$this->serif_fonts = array('dejavuserifcondensed', 'serif', 'dejavuserif', 'freeserif', 'liberationserif',
	...
	'norasi', 'charis', 'palatino', 'constantia', 'georgia', 'albertus', 'xbzar', 'algerian', 'garamond','khmeros','battambang','khmerfef1','khmerfef2'
);

$this->mono_fonts = array('dejavusansmono', 'mono', 'monospace', 'freemono', 'liberationmono', 'courier', 'ocrb', 'ocr-b', 'lucidaconsole',
	'couriernew', 'monotypecorsiva','khmeros','battambang','khmerfef1','khmerfef2'
);
